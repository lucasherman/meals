...
piers_z_kurczaka_z_ryzem_i_rodzynkami = ['200 g piersi z kurczaka', '100 g ryżu' '50 g rodzynek']
twarog_z_owocami = ['200 g chudego twarogu', '2 banany', '20 g suszonych daktyli']
indyk_z_makaronem = ['200 g piersi z indyka', '100 g makaronu', 'kukurydza', 'pomidory', 'ogórki', 'rzodkiewki']

ryz_na_slodko = ['100g ryzu', '2 miarki odzywki bialkowej', '1 jabłko']
kasza_jaglana_z_rodzynkami = ['100g kaszy jaglanej', '50g rodzynek']
shake_z_ryzem_i_bananami = ['100g ryzu', '0,5 litra mleka ryzowego', '2 banany']